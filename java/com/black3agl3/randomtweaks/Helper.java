...
public class Helper {
	...
	public static void preInit () {
		...
		GameRegistry.addShapelessRecipe(snowBucketItemStack, new Object[] {
				Items.bucket, Blocks.snow });
		
		GameRegistry.addSmelting(snowBucketItemStack, new ItemStack(
	...
	/**
	 * Registers any object for you e.g. Block,Item
	 * 
	 * @param obj
	 */
	public static void register (Object obj) {
		...
		if (obj instanceof Block) {
			...
			GameRegistry.registerBlock(block,
					unwrapUnlocalizedName(block.getUnlocalizedName()));
		}
		else if (obj instanceof Item) {
			Item item = (Item) obj;
			GameRegistry.registerItem(item,
					unwrapUnlocalizedName(item.getUnlocalizedName()));
		}
		else
	...
	private static String unwrapUnlocalizedName (String unlocalizedName) {
		...
		if (endindex < 0)
			return unlocalizedName.substring(startindex);
		else
			return unlocalizedName.substring(startindex, endindex);
	}
